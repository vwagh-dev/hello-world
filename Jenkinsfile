    ...
    stages {
        ...
        stage('Coverage') {
            steps {
                ...
                recordCoverage tools: [[parser: 'JACOCO', pattern: '**/target/site/jacoco/jacoco.xml']], id: 'jacoco', name: 'JaCoCo Coverage'
                //equivalent => recordCoverage tools: [jacoco(pattern: '**/target/site/jacoco/jacoco.xml')]
            }
        }
    }
}
